...
конвейер из 17 ролей. Каждая роль — это **отдельный суб-агент** с узкой
...
Заведи задачи через `TaskCreate` на все 17 этапов, отмечай выполненными
